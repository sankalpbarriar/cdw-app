        ...
        <div className="bg-white py-16 sm:py-24">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-8xl sm:text-center">
                    <h2 className="text-base md:text-2xl font-semibold leading-7 text-gray-600">
            ...
            <div className="relative overflow-hidden pt-16 -mb-16 sm:-mb-24 xl:mb-0">
                <div
                    ...
                    style={{
                        backgroundImage: `url(${imgixLoader({ src: imageSource.featureSection, width: 1280, quality: 100 })})`,
                    }}
                />
