...
export const OurBrandSection = async () => {
        ...
        <div className="py-16 sm:py-24 bg-white">
            <div className="max-w-7xl mx-auto px-6 lg:px-8 space-y-12">
                <div className="px-6 lg:px-8 sm:text-center">
                    <h2 className="mt-2 uppercase text-4xl tracking-tight font-bold text-gray-900 sm:text-5xl">Our Brands</h2>
                    <p className="mt-6 text-lg leading-8 text-gray-600">We have {`${count}`} vehicles in stock, ready for same-day drive away
                    </p>
                </div>
