...
export const FinalClassifiedSchema = z.object({
  makeId: z.number(),
  modelId: z.number(),
  year: z.number(),
  fuelType: z.nativeEnum(FuelType),
  bodyType: z.nativeEnum(BodyType),
  modelVariantId: z.number().optional().nullable(),
  ...
  odoUnit: z.nativeEnum(OdoUnit),
  title: z.string(),
  image: z.string().url(),
});
export type FinalClassifiedType = z.infer<typeof FinalClassifiedSchema>;
