...
export const CustomPagination = (props: PaginationProps) => {
    ...
    useEffect(() => {
        ...
        const newStart = Math.max(1, Math.max(1, Math.min(currentPage - halfVisible, totalPages - maxVisiblePages + 1)));
    ...
    return (
        <PaginationRoot className={styles.paginationRoot}>
            <PaginationContent className="lg:gap-4 text-black justify-end">
                <PaginationItem>
                    <PaginationPrevious
                        className={cn(
